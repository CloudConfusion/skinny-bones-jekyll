...
<figure class="wp-caption aligncenter" style="width: 662px" markdown="1">![The objects referenced in the task sequence cannot be found. Verify that the objects exists and that the task sequence references the correct object name and location.](https://social.microsoft.com/Forums/getfile/3306/)<figcaption class="wp-caption-text">What you mean can't be found. I added it from a list you nugget!</figcaption></figure>
